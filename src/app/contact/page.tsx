...
export default function Contact() {
  return (
      <div className='text-center font-jost'>
        ...
        <form className="px-7 py-[20rem] grid justify-center items-center">
          ...
          <div className='flex mx-auto justify-evenly py-10 w-24'>
            ...
            <Link href='https://www.instagram.com/rosemondfilms/'>
