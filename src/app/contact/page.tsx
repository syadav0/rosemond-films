...
export default function Contact() {
  ...
  return (
      <div className='text-center font-jost px-10 mb-40'>
        <form className="h-screen grid justify-center items-center" onSubmit={handleSubmit}>
          <div className="grid gap-6" id="form">
            ...
            <div className="grid gap-6 w-full text-xl">
              <input className="p-3 shadow-2xl glass w-full outline-none focus:border-solid focus:border-[#035ec5] border-[1px]" 
              type="Email" 
              placeholder="Email"  
              value={email}
            ...
            <div className="flex gap-3 h-[20rem] text-xl">
              <textarea className="p-3 shadow-2xl glass w-full outline-none focus:border-solid focus:border-[#035ec5] border-[1px] resize-none" 
              placeholder="Message"
              value={msg}
            ...
            <button className="glass w-full p-3 hover:bg-white hover:text-black ease-in-out duration-300 border-[2px] text-white font-jost text-xl" 
